...
const SignupPage = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-gradient-to-br from-gray-900 to-gray-800">
      {/* Left Side - Form */}
      <div className="flex flex-col justify-center items-center w-full md:w-1/2 p-4 md:p-8 order-2 md:order-1">
        <div className="w-full max-w-md bg-gray-800 rounded-xl shadow-xl border border-gray-700 overflow-hidden">
          <div className="p-6 md:p-8">
            <h1 className="text-3xl md:text-4xl font-bold mb-2 text-green-500">Sign Up</h1>
            ...
            <form className="w-full space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="dob" className="block text-gray-400 text-sm font-medium mb-2">
                    Date of Birth
                  </label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                ...
                <div>
                  <label htmlFor="gender" className="block text-gray-400 text-sm font-medium mb-2">
                    Gender
                  </label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                    ...
                    <select
                      id="gender"
                      className="w-full pl-10 p-3 rounded-lg bg-gray-700 text-white border border-gray-600 focus:border-green-500 focus:outline-none focus:ring-1 focus:ring-green-500 transition-all duration-200 appearance-none"
                    >
              ...
              <button
                type="submit"
                className="w-full bg-green-600 hover:bg-green-700 text-white font-medium px-4 py-3 rounded-lg transition-colors duration-200 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50"
              >
                Create Account
              </button>
            </form>
      ...
      {/* Right Side - Image */}
      <div className="w-full md:w-1/2 order-1 md:order-2 flex items-center justify-center bg-gradient-to-bl from-gray-800 to-gray-900">
